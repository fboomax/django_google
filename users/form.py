...
class UserForm(UserCreationForm):
  ...
  username = forms. EmailField(max_length=30, required = True, widget = forms.TextInput(attrs={'placeholder': '*Email ...'}))

  password1 = forms. CharField(widget = forms.PasswordInput(attrs={'placeholder': '*YPassword..','class':'password'}))

  password2 = forms. CharField(widget = forms.PasswordInput(attrs={'placeholder': '*Confirm Password..', 'clas':'password'}))
...
class AuthForm(AuthenticationForm):
  ...
  password = forms.PasswordInput(max_length=254, required=True, widget = forms.TextInput(attrs={'placeholder':'*Password..', 'class':'password'}))
